    ...
    <StickerIcon {...props} withShadow={false} title="More Actions">
      {({ keyline }) => {
        if (keyline) {
          return (
            <>
              <circle cx="14" cy="24" r="6.5" fill="black" stroke="black" strokeWidth="4" />
              <circle cx="24" cy="24" r="6.5" fill="black" stroke="black" strokeWidth="4" />
              <circle cx="34" cy="24" r="6.5" fill="black" stroke="black" strokeWidth="4" />
            </>
          )
        }
