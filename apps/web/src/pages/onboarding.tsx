        ...
        {cropImage && (
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-2 sm:p-6 relative min-h-0">
              <div className="relative w-64 h-64 rounded-full overflow-hidden border-4 border-[#58CC02] shadow-[0_0_30px_rgba(88,204,2,0.2)] bg-gray-950 cursor-move flex items-center justify-center select-none relative"
